...
class WordLadder {
  ...
  private:
    ...
    bool exists(const string &word); //private helper function
    stack<string> DoWordLadder(const string&firstWord, const string&secondWord); //Find Word Ladder
    bool compareStrings(const string &wordOne, const string &wordTwo); //finding Off By one
